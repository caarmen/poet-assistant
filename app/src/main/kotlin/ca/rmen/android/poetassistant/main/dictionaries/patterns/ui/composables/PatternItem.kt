...
const val PATTERN_ITEM_STAR_TAG = "PatternItem_Star_"
const val PATTERN_ITEM_ROW_TAG = "PatternItem_Row_"
...
fun PatternItem(
    ...
    Row(
        modifier = modifier
            ...
            .testTag("${PATTERN_ITEM_ROW_TAG}$word"),
        ...
        IconToggleButton(
            ...
            modifier = Modifier
                .size(40.dp)
                .testTag("$PATTERN_ITEM_STAR_TAG$word")
        ) {
            Icon(
